...
{
	[ProtoContract]
	public partial class WorldFinishStageFirstRequestPacket : IRequestPacket
	{
        ...
        public WorldFinishStageFirstRequestPacket( int worldnum,  int stagenum,  int star,  List<ObjValue> rewardvaluelist )
	    {   
        ...
        public WorldFinishStageFirstRequestPacket()
        {
        }
