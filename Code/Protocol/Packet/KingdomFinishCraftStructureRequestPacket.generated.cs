...
{
	[ProtoContract]
	public partial class KingdomFinishCraftStructureRequestPacket : IRequestPacket
	{
        ...
        public KingdomFinishCraftStructureRequestPacket( ulong kingdomstructureid,  int kingdomitemnum )
	    {   
        ...
        public KingdomFinishCraftStructureRequestPacket()
        {
        }
